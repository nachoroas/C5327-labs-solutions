...
def case_1():
    ...
    try:
        ...
        print("Closing...")
        sock_input.close()
    print("Notamos que con 12345678 el largo de la cadena cifrada cambia, y con 1, el largo sigue siendoel mismo que el de 12345678, por ende, la llave debe tener un largo de 7 bytes (si suma 16 entonces cambia)")
